...
| API      | 하는 일                                             |
| -------- | --------------------------------------------------- |
| `init()` | 새로고침에 필요한 값을 받아 새 인스턴스를 만들어요. |
...
| API               | 하는 일                                                        |
| ----------------- | -------------------------------------------------------------- |
| `tintColor`       | 관련 값과 동작의 현재 값이나 설정을 읽고 필요한 경우 변경해요. |
| `attributedTitle` | 관련 값과 동작의 현재 값이나 설정을 읽고 필요한 경우 변경해요. |
...
| `isRefreshing`      | 새로고침의 활성화 여부나 현재 상태를 나타내요. |
