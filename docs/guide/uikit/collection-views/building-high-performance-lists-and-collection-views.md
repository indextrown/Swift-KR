...
Apple 공식 페이지는 이 샘플이 WWDC21의 **Make blazing fast lists and collection views** 세션과 연결된 프로젝트라는 점을 안내해요. 공식 페이지 자체에는 별도의 단계별 본문이나 코드가 없어서, 아래 내용은 그 성능 주제를 실제 앱에 적용하도록 확장한 **Swift-KR 보충 학습 자료**예요.
