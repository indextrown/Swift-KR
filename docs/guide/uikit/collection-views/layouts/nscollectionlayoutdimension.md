...
| API                                | 하는 일                                              |
| ---------------------------------- | ---------------------------------------------------- |
| `absolute(_:)`                     | 크기의 현재 값이나 설정을 읽고 필요한 경우 변경해요. |
| `estimated(_:)`                    | 크기의 현재 값이나 설정을 읽고 필요한 경우 변경해요. |
| `fractionalHeight(_:)`             | 크기의 현재 값이나 설정을 읽고 필요한 경우 변경해요. |
| `fractionalWidth(_:)`              | 크기의 현재 값이나 설정을 읽고 필요한 경우 변경해요. |
| `uniformAcrossSiblings(estimate:)` | 크기의 현재 값이나 설정을 읽고 필요한 경우 변경해요. |
...
| API         | 하는 일                                              |
| ----------- | ---------------------------------------------------- |
| `dimension` | 크기의 현재 값이나 설정을 읽고 필요한 경우 변경해요. |
...
| API                       | 하는 일                                    |
| ------------------------- | ------------------------------------------ |
| `isAbsolute`              | 크기의 활성화 여부나 현재 상태를 나타내요. |
| `isEstimated`             | 크기의 활성화 여부나 현재 상태를 나타내요. |
| `isFractionalHeight`      | 크기의 활성화 여부나 현재 상태를 나타내요. |
| `isFractionalWidth`       | 크기의 활성화 여부나 현재 상태를 나타내요. |
| `isUniformAcrossSiblings` | 크기의 활성화 여부나 현재 상태를 나타내요. |
