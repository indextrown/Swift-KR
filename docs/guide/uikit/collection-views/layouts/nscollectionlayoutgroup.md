...
NSCollectionLayoutGroup은 하나 이상의 item을 가로·세로 또는 사용자 정의 위치로 배치하고 section에서 반복할 묶음을 만들어요.

group은 item처럼 다른 item이나 group과 조합할 수 있어요. 큰 item 하나와 작은 item 두 개를 담은 중첩 group도 만들 수 있어요.
