...
| API                                                        | 하는 일                                            |
| ---------------------------------------------------------- | -------------------------------------------------- |
| `init(layoutSize:elementKind:containerAnchor:)`            | 보조 뷰에 필요한 값을 받아 새 인스턴스를 만들어요. |
| `init(layoutSize:elementKind:containerAnchor:itemAnchor:)` | 보조 뷰에 필요한 값을 받아 새 인스턴스를 만들어요. |
...
| API               | 하는 일                                                        |
| ----------------- | -------------------------------------------------------------- |
| `itemAnchor`      | item의 현재 값이나 설정을 읽고 필요한 경우 변경해요.           |
| `containerAnchor` | 관련 값과 동작의 현재 값이나 설정을 읽고 필요한 경우 변경해요. |
