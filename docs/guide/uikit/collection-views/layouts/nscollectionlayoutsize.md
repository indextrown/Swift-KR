...
description: 'NSCollectionLayoutSize는 두 개의 NSCollectionLayoutDimension을 묶어 레이아웃 요소의 너비와 높이를 정의해요. 주요 API, 사용 예제, 주의점을 함께 정리합니다.'
---

# NSCollectionLayoutSize

> **면접 답변 한 줄 요약:** `NSCollectionLayoutSize`는 두 개의 `NSCollectionLayoutDimension`을 묶어 레이아웃 요소의 너비와 높이를 정의해요.
...
NSCollectionLayoutSize는 두 개의 NSCollectionLayoutDimension을 묶어 레이아웃 요소의 너비와 높이를 정의해요.
...
### layout size 만들기 (Creating a layout size)
...
- [Apple Developer Documentation — NSCollectionLayoutSize](https://developer.apple.com/documentation/uikit/nscollectionlayoutsize)
