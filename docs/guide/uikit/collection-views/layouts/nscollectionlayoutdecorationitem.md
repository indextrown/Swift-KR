...
Decoration Item 종류마다 고유한 element kind가 필요해요. 문자열을 쉽게 식별하고 같은 곳에서 관리할 수 있도록 다음처럼 모아 둘 수 있어요.
...
section의 `decorationItems`에 배경 Decoration Item을 추가하고, Compositional Layout에 실제 Decoration View class를 등록하면 section 배경을 표시할 수 있어요.
