...
| Marker                                                          | Annotation                                                          |
| --------------------------------------------------------------- | ------------------------------------------------------------------- |
| ![지도 위에 표시된 Mapbox 기본 마커](../assets/data-marker.png) | ![지도 위에 표시된 여러 어노테이션](../assets/data-annotations.png) |
| 기본 디자인을 빠르게 사용해요.                                  | 점·원·선·면을 개별 설정해요.                                        |

| View Annotation                                                                    | Style Layer                                                                    |
| ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| ![지도 위에 표시된 동적 View Annotation 카드](../assets/data-view-annotations.png) | ![지도 내부 Style Layer로 표시된 여러 아이콘](../assets/data-style-layers.png) |
